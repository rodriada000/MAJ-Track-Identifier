...
if __name__ == "__main__":
    ...
    if config.get('spotify') is not None and len(playlist.songs) > 0:
        ...
        spotify_playlist, tracks_added = spotify_client.create_setlist_playlist(playlist, name_prefix=prefix, description=descr, is_public=False, is_collab=True, verbose=True)
